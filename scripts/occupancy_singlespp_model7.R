...
params <- c("psi.pred","int.p","int.psi","beta.site.type","beta.year","beta.site.type.year")
...
params <- c("psi.pred[1, 1]","psi.pred[1, 2]","psi.pred[1, 3]","psi.pred[1, 4]","psi.pred[1, 5]","psi.pred[1, 6]","psi.pred[1, 7]","psi.pred[1, 8]","psi.pred[1, 9]","psi.pred[1, 10]","psi.pred[1, 11]","psi.pred[1, 12]",
            ...
            "int.p","int.psi","beta.site.type[2]","beta.year","beta.site.type.year[2]") 
...
#R-hat 
results.mat[i,118] <- gelman.diag(out$samples[,c(2,4,5,6,7)],multivariate=TRUE)$mpsrf
...
write.csv(results.mat,"results/occ_model7_results.csv")
write.csv(all.species,"results/occ_model7_allspp.csv")
